...
describe Api::V1::MattermostController do
  let!(:user) { FactoryBot.create(:user, email: "cool.kittens@eff.org") }
  ...
  describe "#set_my_where" do
    let(:text) { Faker::ChuckNorris.fact.parameterize(separator: "+") }
    let(:command) { Commands::SetMyWhere }
    subject(:create) { post :set_my_where, params: slash_params }
  ...
  describe "#where_is" do
    ...
    subject(:create) { post :where_is, params: slash_params }
  ...
  describe "#add_fab_back" do
    ...
    subject(:create) { post :add_fab_back, params: slash_params }
  ...
  describe "#add_fab_forward" do
    ...
    subject(:create) { post :add_fab_forward, params: slash_params }
