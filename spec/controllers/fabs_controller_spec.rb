  ...
  describe 'POST #create' do
    ...
    context 'When authenticated correctly' do
      it 'creates the fab for self' do
        post :create, params: { user_id: @user.id, fab: { user_id: @user.id } }
    ...
    context 'when not authenticated correctly' do
      it 'does not create a fab for a user other than you' do
        post :create, params: { user_id: @other.id, fab: { user_id: @other.id } }
  ...
  describe 'DELETE #destroy' do
    ...
    context 'When authenticated correctly' do
      ...
      it 'deletes the fab for self' do
        ...
        expect{
          delete :destroy, params: { user_id: @user.id, id: @user.fabs.first.id }
    ...
    context 'When not authenticated correctly' do
      it 'does not delete the fab for other' do
        ...
        expect{
          delete :destroy, params: { user_id: @other.id, id: @other.fabs.first.id }
